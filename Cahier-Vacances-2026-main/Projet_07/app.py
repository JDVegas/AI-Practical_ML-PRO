...
demande = {"destination":destination, "date_depart":date_texte, "nuits":nuits, "voyageurs":voyageurs, "budget_max":budget, "envie":envie}           # (2) rassemble la demande dans un dictionnaire à 6 clés
